...
export default function pokemonDataPage(){
  ...
  return( 
    <Div className={"container-fluid px-5 info-page"}>
      {
      pokemonData === null ? 
        (
        <Loader />
          ...
          <Div className={"container pokemon-data p-3"}>
            <Div className={"pokemon-name-image px-3 d-flex flex-column align-items-center line-after"}>
                ...
                <Div className="pokemon-image-div d-flex justify-content-center">
                  ...
                  <img className="pokemon-image-background" src="/images/pokebola.png" alt="background-pokeball" />
                </Div>
            ...
            <Div className={"pokemon-evolutions-block px-3 pb-1"}> 
              <h2 className="h2 mt-2">
                Linha evolutiva do pokemon
              </h2>
              <EvolutionsPart />
            </Div> {/* .pokemon-evolutions-block end */}
